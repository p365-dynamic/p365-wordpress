...
class TB_Pro_Slider_Module extends Themify_Builder_Component_Module {
    ...
    public function get_styling() {
        $general = array(
			...
			self::get_image('.module-pro-slider'),
            self::get_color('.module-pro-slider', 'background_color', __('Background Color', 'themify'), 'background-color'),
			self::get_repeat('.module-pro-slider'),
			self::get_position('.module-pro-slider'),
            //Slide Text Container
            self::get_seperator('text', __('Slide Text Container', 'builder-slider-pro')),
            self::get_color('.module-pro-slider .sp-slide-text', 's_t_c_b_c', __('Background Color', 'themify'), 'background-color'),
			self::get_padding('.module-pro-slider .sp-slide-text','s_t_c_p'),
			self::get_border('.module-pro-slider .sp-slide-text','s_t_c_b'),
            //Title 
			...
			! method_exists( __CLASS__, 'get_element_font_weight' ) ? '' : self::get_element_font_weight( '.module-pro-slider .bsp-slide-post-title', 'title_font_weight' ),
			self::get_color(array( '.module-pro-slider .bsp-slide-post-title' ),'f_c_title',__('Font Color', 'themify')),
			...
			self::get_text_align('.module-pro-slider .bsp-slide-post-title', 't_a_title'),
			self::get_text_transform('.module-pro-slider .bsp-slide-post-title', 'text_transform_title'),
			self::get_font_style('.module-pro-slider .bsp-slide-post-title', 'font_style_title','font_style_blod_title'),
            //Text 
			...
			! method_exists( __CLASS__, 'get_element_font_weight' ) ? '' : self::get_element_font_weight( array('.module-pro-slider .bsp-slide-excerpt', '.module-pro-slider .bsp-slide-excerpt p'), 'text_font_weight' ),
			self::get_color(array('.module-pro-slider .bsp-slide-excerpt', '.module-pro-slider .bsp-slide-excerpt p'),'f_c_text',__('Font Color', 'themify')),
			...
			self::get_letter_spacing(array('.module-pro-slider .bsp-slide-excerpt', '.module-pro-slider .bsp-slide-excerpt p'), 'letter_spacing_text'),
			self::get_text_align(array('.module-pro-slider .bsp-slide-excerpt', '.module-pro-slider .bsp-slide-excerpt p'), 't_a_text'),
			self::get_text_transform(array('.module-pro-slider .bsp-slide-excerpt', '.module-pro-slider .bsp-slide-excerpt p'), 'text_transform_text'),
			self::get_font_style(array('.module-pro-slider .bsp-slide-excerpt', '.module-pro-slider .bsp-slide-excerpt p'), 'font_style_text','font_style_blod_text'),
            // Padding
        ...
        $action_button = array(
			...
			! method_exists( __CLASS__, 'get_element_font_weight' ) ? '' : self::get_element_font_weight( '.module-pro-slider .bsp-slide-button', 'button_font_weight' ),
        ...
        <div class="module module-<?php echo $this->slug; ?> pager-{{data.builder_ps_triggers_position}} pager-type-{{data.builder_ps_triggers_type}} {{data.css_slider_pro}}" data-thumbnail-width="{{ data.builder_ps_thumb_width }}" data-thumbnail-height="{{ data.builder_ps_thumb_height }}" data-autoplay="{{ data.builder_ps_aa }}" data-hover-pause="{{ data.builder_ps_hover_pause }}" data-timer-bar="{{ data.builder_ps_timer }}" data-slider-width="{{ data.builder_ps_fullscreen && data.builder_ps_fullscreen == 'fullscreen' ? '100%' : data.builder_ps_width }}" data-slider-height="{{ data.builder_ps_fullscreen && data.builder_ps_fullscreen == 'fullscreen' ? '100vh' : data.builder_ps_height }}">
            ...
            <div class="slider-pro"  style="visibility: hidden;">
                <div class="sp-slides">
                    ...
                    styles.push( '.' + module_id + '.module-pro-slider .sp-slide-' + index + ' .bsp-slide-excerpt, .' + module_id + ' .sp-slide-' + index + ' .bsp-slide-excerpt p,.' + module_id + '.module-pro-slider .sp-slide-' + index + ' .sp-slide-text .bsp-slide-post-title{ color: ' + themifybuilderapp.Utils.toRGBA( slide.builder_ps_text_color ) + '; }' );
                    }
