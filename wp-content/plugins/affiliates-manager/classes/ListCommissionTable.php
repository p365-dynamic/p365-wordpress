...
//    }
    ...
    function get_columns() {
        $columns = array(
            ...
            'transactionId' => __('Sr No', 'affiliates-manager'),
            ...
            'amount' => __('Overall Commission', 'affiliates-manager'),
    ...
    function prepare_items() {
        ...
        $query = "SELECT * FROM $records_table_name INNER JOIN $aff_table_name ON $records_table_name.affiliateId = $aff_table_name.affiliateId WHERE type = 'credit' ORDER BY $orderby_column $sort_order";
