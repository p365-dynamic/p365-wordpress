...
//    }
    ...
    function get_columns() {
        $columns = array(
            ...
            'trackingTokenId' => __('Sr No', 'affiliates-manager'),
    ...
    function prepare_items() {
        ...
        $query = "SELECT * FROM $records_table_name INNER JOIN $aff_table_name ON $records_table_name.sourceAffiliateId = $aff_table_name.affiliateId ORDER BY $orderby_column $sort_order";
