...
<?php } ?>
        ...
        foreach ($this->viewData['paymentMethods'] as $key => $val) {
            ...
            echo "<option value='{$key}'{$selected_html}>Cheque</option>";
        }
        ?>
                            </select></td>
                    </tr>
    ...
    <?php endif; ?>
                    ...
                    <tr>
                        <td>
                            <label for="ddBountyType"><?php _e('Renumeration Type *', 'affiliates-manager') ?></label>
                        </td>
                        <td>
                            <select id="ddBountyType" name="ddBountyType">
                                ...
                                $select = array('percent' => __('Percentage of Sales', 'affiliates-manager'),
                                    ...
                                    'cost_per_lead' => __('Cost Per Lead', 'affiliates-manager'),
                                    'cost_per_visit' => __('Cost Per Visit', 'affiliates-manager')
                                );
                                ...
                                $label = isset($this->viewData['bountyType']) && $this->viewData['bountyType'] == 'fixed' ?
                                        sprintf(__('Renumeration Rate (%s per Sale) *', 'affiliates-manager'), $currency) : __('Renumeration Rate (% of Sale) *', 'affiliates-manager');
                    ...
                    <tr>
                        <td><label id='lblBountyAmount' for='txtBountyAmount'><?php echo "Renumeration Amount"; ?></label></td>
