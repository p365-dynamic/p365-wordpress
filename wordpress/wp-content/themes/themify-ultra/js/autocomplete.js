...
(function($) {
    var Autocomplete = function() {
        function Autocomplete(element, options) {
            ...
            this.$container.append('<span class="input-group-btn">' + '<button class="drop_button btn btn-default" type="button" tabindex="-1">' + '</button></span>');
            this.$container.append('<ul class="items foo dropdown-menu" style="display:none; padding:3px 3px !important;"></ul>');
        ...
        _createClass(Autocomplete, [{
            ...
            value: function setButtonIcon() {
                this.$button.html('<span class="' + (this.open ? 'fa fa-angle-up' : 'fa fa-angle-down') + '"></span>');
            }
        }, {
            key: 'search',
            ...
            value: function setMenuDirection() {
                ...
                requestAnimationFrame(function() {
                    ...
                    if (noSpaceBelow && spaceAbove) {
                        ...
                        _this5.$items.offset({ top: inputOffset.top + inputHeight + inputMarginTop + 16, left: inputOffset.left - 12 });
                    }
                });
            }
        }, {
